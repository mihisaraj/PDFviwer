...
function Home() {
    ...
    const [currentMatchIndex, setCurrentMatchIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(-1);
    ...
    const [isIndexing, setIsIndexing] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const textCacheRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({});
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            ...
            ({
                "Home.useEffect": async ()=>{
                    for(let pageNum = 1; pageNum <= pdfDoc.numPages; pageNum++){
                        ...
                        const text = textContent.items.map({
                            "Home.useEffect.text": (item)=>item.str || ''
                        }["Home.useEffect.text"]).join(' ');
                        textCacheRef.current[pageNum] = text;
                        if (cancelled) return;
                    }
                    if (!cancelled) {
                        setIsIndexing(false);
                ...
                "Home.useEffect": (err)=>{
                    if (!cancelled) {
                        console.error('Failed to index PDF text', err);
                        setIsIndexing(false);
                    }
                }
            }["Home.useEffect"]);
    ...
    const runSearch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Home.useCallback[runSearch]": async (query)=>{
            if (!pdfDoc) return [];
            const normalizedQuery = query.trim().toLowerCase();
            if (!normalizedQuery) return [];
            const matches = [];
            for(let pageNum = 1; pageNum <= pdfDoc.numPages; pageNum++){
                let text = textCacheRef.current[pageNum];
                if (!text) {
                    const page = await pdfDoc.getPage(pageNum);
                    const textContent = await page.getTextContent();
                    text = textContent.items.map({
                        "Home.useCallback[runSearch]": (item)=>item.str || ''
                    }["Home.useCallback[runSearch]"]).join(' ');
                    textCacheRef.current[pageNum] = text;
                }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            ...
            let active = true;
            setIsSearching(true);
            runSearch(searchQuery).then({
                "Home.useEffect": (matches)=>{
                    if (!active) return;
    ...
    const handleSearchNext = ()=>{
        ...
        const nextIndex = currentMatchIndex === -1 ? 0 : (currentMatchIndex + 1) % searchMatches.length;
        setCurrentMatchIndex(nextIndex);
        goToPage(searchMatches[nextIndex]);
    };
    const handleSearchPrev = ()=>{
        if (searchMatches.length === 0) return;
        const prevIndex = currentMatchIndex <= 0 ? searchMatches.length - 1 : (currentMatchIndex - 1) % searchMatches.length;
        setCurrentMatchIndex(prevIndex);
        goToPage(searchMatches[prevIndex]);
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "relative h-screen flex flex-col gap-6 px-4 sm:px-10 pb-28 pt-10 max-w-7xl mx-auto",
                children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "text-xs uppercase tracking-[0.28em] text-hts-secondary",
                                                        children: "Handbook"
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/page.tsx",
                                                        lineNumber: 311,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                                        ...
                                                        children: "Harbour Tech Solutions · 2025"
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/page.tsx",
                                                        lineNumber: 312,
                                                        columnNumber: 17
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: "h-11 w-11 rounded-2xl bg-white/70 dark:bg-white/10 border border-white/50 dark:border-white/15 flex items-center justify-center text-hts-primary dark:text-hts-secondary hover:-translate-y-0.5 transition-all",
                                        title: "Search PDF",
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$search$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Search$3e$__["Search"], {
                                            className: "w-5 h-5"
                                        }, void 0, false, {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "absolute inset-0 rounded-[28px] border border-white/15 dark:border-white/10 bg-white/70 dark:bg-white/5 backdrop-blur-[24px] shadow-[0_40px_120px_-50px_rgba(0,0,0,0.7)] overflow-hidden",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "absolute inset-0 pointer-events-none bg-gradient-to-b from-white/10 via-transparent to-black/10 dark:from-white/5"
                                    }, void 0, false, {
                                        fileName: "[project]/app/page.tsx",
                                        lineNumber: 350,
                                        columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "absolute left-1/2 -translate-x-1/2 -bottom-10 px-4 py-2 rounded-full bg-white/80 dark:bg-white/10 border border-white/40 dark:border-white/15 text-xs sm:text-sm tracking-[0.22em] uppercase text-gray-700 dark:text-gray-200 shadow-lg",
                                children: [
                                    "Page ",
                                    currentPage,
                                    " of ",
...
_s(Home, "aMpt+6sJ/fwGMWkw74edIAP11lQ=", false, function() {
    return [
...
//# sourceMappingURL=_b60c141f._.js.map